...
export const ArrowRightCMP = (props: any) => (
  <svg width="1em" height="1em" viewBox="0 0 24 24" data-testid="arrow-right" {...props}>
...
export const ArrowLeftCMP = (props: any) => (
  <svg width="1em" height="1em" viewBox="0 0 24 24" data-testid="arrow-left" {...props}>
...
export const DateIcon = (props: any) => (
  <svg width="1em" height="1em" viewBox="0 0 24 24" data-testid="date-icon" {...props}>
...
export const ClockIcon = (props: any) => (
  <svg width="1em" height="1em" viewBox="0 0 24 24" data-testid="clock-icon" {...props}>
    <path fill="none" d="M0 0h24v24H0V0z" />
